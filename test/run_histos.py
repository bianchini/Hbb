...
for n_cut,cut in enumerate(cuts_map):
  ...
  histo_map[cut[0]] = {
    ...
    "Mass" : ROOT.TH1F(cut[0]+"_Mass", argv[1]+": "+cut[0]+"_Mass", 720, 400, 4000),
    "Mass_JECUp" : ROOT.TH1F(cut[0]+"_Mass_JECUp", argv[1]+": "+cut[0]+"_Mass_JECUp", 720, 400, 4000),
    "Mass_JECDown" : ROOT.TH1F(cut[0]+"_Mass_JECDown", argv[1]+": "+cut[0]+"_Mass_JECDown", 720, 400, 4000),
    "Mass_JERUp" : ROOT.TH1F(cut[0]+"_Mass_JERUp", argv[1]+": "+cut[0]+"_Mass_JERUp", 720, 400, 4000),
    "Mass_JERDown" : ROOT.TH1F(cut[0]+"_Mass_JERDown", argv[1]+": "+cut[0]+"_Mass_JERDown", 720, 400, 4000),
    "MassFSR" : ROOT.TH1F(cut[0]+"_MassFSR", argv[1]+": "+cut[0]+"_MassFSR", 720, 400, 4000),
    "MassFSR_JECUp" : ROOT.TH1F(cut[0]+"_MassFSR_JECUp", argv[1]+": "+cut[0]+"_MassFSR_JECUp", 720, 400, 4000),
    "MassFSR_JECDown" : ROOT.TH1F(cut[0]+"_MassFSR_JECDown", argv[1]+": "+cut[0]+"_MassFSR_JECDown", 720, 400, 4000),
    "MassFSR_JERUp" : ROOT.TH1F(cut[0]+"_MassFSR_JERUp", argv[1]+": "+cut[0]+"_MassFSR_JERUp", 720, 400, 4000),
    "MassFSR_JERDown" : ROOT.TH1F(cut[0]+"_MassFSR_JERDown", argv[1]+": "+cut[0]+"_MassFSR_JERDown", 720, 400, 4000),
    "MassAK08" : ROOT.TH1F(cut[0]+"_MassAK08", argv[1]+": "+cut[0]+"_MassAK08", 720, 400, 4000),
...
for iev in range( min(int(1e+9), chain.GetEntries()) ):
    ...
    variables["Mass_JERUp"] = ev.HCSV_mass * math.sqrt( ev.Jet_corr_JERUp[ev.hJCidx[0]]*ev.Jet_corr_JERUp[ev.hJCidx[1]]/ev.Jet_corr[ev.hJCidx[0]]/ev.Jet_corr[ev.hJCidx[1]]) if len(ev.hJCidx)==2  and lumi_factor>0 and ev.Jet_corr_JERUp[ev.hJCidx[0]]>0. and ev.Jet_corr_JERUp[ev.hJCidx[1]]>0. else ev.HCSV_mass
    variables["Mass_JERDown"] = ev.HCSV_mass * math.sqrt( ev.Jet_corr_JERDown[ev.hJCidx[0]]*ev.Jet_corr_JERDown[ev.hJCidx[1]]/ev.Jet_corr[ev.hJCidx[0]]/ev.Jet_corr[ev.hJCidx[1]]) if len(ev.hJCidx)==2  and lumi_factor>0 and ev.Jet_corr_JERDown[ev.hJCidx[0]]>0. and ev.Jet_corr_JERDown[ev.hJCidx[1]]>0. else ev.HCSV_mass
    ...
    variables["MassFSR_JERUp"] = ev.HaddJetsdR08_mass * math.sqrt( ev.Jet_corr_JERUp[ev.hJCidx[0]]*ev.Jet_corr_JERUp[ev.hJCidx[1]]/ev.Jet_corr[ev.hJCidx[0]]/ev.Jet_corr[ev.hJCidx[1]]) if len(ev.hJCidx)==2  and lumi_factor>0 and ev.Jet_corr_JERUp[ev.hJCidx[0]]>0. and ev.Jet_corr_JERUp[ev.hJCidx[1]]>0. else ev.HaddJetsdR08_mass
    variables["MassFSR_JERDown"] = ev.HaddJetsdR08_mass * math.sqrt( ev.Jet_corr_JERDown[ev.hJCidx[0]]*ev.Jet_corr_JERDown[ev.hJCidx[1]]/ev.Jet_corr[ev.hJCidx[0]]/ev.Jet_corr[ev.hJCidx[1]]) if len(ev.hJCidx)==2  and lumi_factor>0 and ev.Jet_corr_JERDown[ev.hJCidx[0]]>0. and ev.Jet_corr_JERDown[ev.hJCidx[1]]>0. else ev.HaddJetsdR08_mass
